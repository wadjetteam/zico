export const USERS = [
  { _id: "u-admin", username: "admin", fullName: "System Administrator", email: "admin@wadjet.local", role: "board" },
  { _id: "u-analyst", username: "analyst", fullName: "Ana Lyte", email: "analyst@wadjet.local", role: "risk_owner" },
  { _id: "u-auditor", username: "auditor", fullName: "Audrey Tor", email: "auditor@wadjet.local", role: "ciso" },
  { _id: "u-manager", username: "manager", fullName: "Morgan Lee", email: "manager@wadjet.local", role: "cro" },
  { _id: "u-officer", username: "officer", fullName: "Owen Fischer", email: "officer@wadjet.local", role: "risk_owner" },
];
...
export const DOMAINS = [
  { _id: "d-1", name: "Information Security", status: "active", scoringMethod: "advanced", description: "CIA triad and security operations", escalationMatrix: { Low: "Risk Owner", Medium: "Risk Owner + CISO", High: "CISO + CRO", Critical: "Board of Directors via Enterprise Risk Register" } },
  { _id: "d-2", name: "Operational", status: "active", scoringMethod: "advanced", description: "Process and service delivery", escalationMatrix: { Low: "Process Owner", Medium: "Process Owner + COO", High: "COO + CRO", Critical: "Board of Directors via Enterprise Risk Register" } },
  { _id: "d-3", name: "Compliance", status: "active", scoringMethod: "max", description: "Regulatory and legal obligations", escalationMatrix: { Low: "Compliance Officer", Medium: "Head of Compliance + CRO", High: "CRO + Legal Counsel", Critical: "Board of Directors via Regulatory Risk Register" } },
  { _id: "d-4", name: "Cybersecurity", status: "active", scoringMethod: "advanced", description: "Cyber threats and incidents", escalationMatrix: { Low: "IT Security Team", Medium: "CISO + IT Security", High: "CISO + CRO", Critical: "Board of Directors via Cyber Risk Committee" } },
  { _id: "d-5", name: "Third Party Risk", status: "active", scoringMethod: "advanced", description: "Vendor and supplier exposure", escalationMatrix: { Low: "Vendor Manager", Medium: "Procurement Director + CRO", High: "CRO + Procurement", Critical: "Board of Directors via Third Party Risk Committee" } },
  { _id: "d-6", name: "Financial", status: "active", scoringMethod: "max", description: "Financial loss and liquidity", escalationMatrix: { Low: "Finance Manager", Medium: "CFO + CRO", High: "CFO + Board", Critical: "Board of Directors via Financial Risk Committee" } },
];
...
export const ASSETS = [
  { _id: "a-1", name: "Core Banking System", type: "Application", owner: "IT Operations", location: "Primary DC", criticality: "Critical", status: "Operational", domain: "Information Security" },
  { _id: "a-2", name: "Mobile Banking App", type: "Application", owner: "Digital Banking", location: "Cloud", criticality: "Critical", status: "Operational", domain: "Cybersecurity" },
  { _id: "a-3", name: "Customer Database", type: "Database", owner: "Data Office", location: "Primary DC", criticality: "Critical", status: "Operational", domain: "Information Security" },
  { _id: "a-4", name: "Email Gateway", type: "Infrastructure", owner: "IT Operations", location: "Secondary DC", criticality: "High", status: "Operational", domain: "Cybersecurity" },
  { _id: "a-5", name: "Payment Hub", type: "Application", owner: "Payments", location: "Primary DC", criticality: "Critical", status: "Operational", domain: "Cybersecurity / Fraud" },
  { _id: "a-6", name: "Branch Network", type: "Infrastructure", owner: "Branch Operations", location: "Branches", criticality: "Medium", status: "Operational", domain: "Operational" },
  { _id: "a-7", name: "HR System", type: "Application", owner: "Human Resources", location: "Cloud", criticality: "High", status: "Operational", domain: "Human Risk" },
  { _id: "a-8", name: "AI Scoring Engine", type: "Application", owner: "Risk", location: "Cloud", criticality: "High", status: "In Deployment", domain: "Emerging Technology / AI" },
];
...
export const EMAIL_CONFIG = { host: "smtp.wadjet.local", port: 587, user: "grc-notifications@wadjet.local", secure: false, fromName: "Wadjet GRC", enabled: true };
