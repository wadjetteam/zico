...
export default function ManageAssets() {
  ...
  const load = useCallback(() => {
    ...
    setError(null);
    Promise.all([
      assets.list({ type: typeFilter || undefined, criticality: critFilter || undefined, classification: classFilter || undefined, environment: envFilter || undefined, status: statusFilter || undefined }),
      assets.get("stats"),
    ])
      .then(([d, s]) => {
        setRows(d.items);
  ...
  }, [typeFilter, critFilter, classFilter, envFilter, statusFilter]);
