...
function ReportsWrapper() {
  ...
  // module param may be 'all', 'risk', 'compliance', etc.
  return <ReportsPage moduleFilter={module || "all"} />;
}
      ...
      <Routes>
        ...
        <Route element={<ProtectedRoute />}>
          <Route element={<AppLayout />}>
            ...
            <Route path="/reports" element={<ReportsPage moduleFilter="all" />} />
            <Route path="/reports/executive" element={<Dashboard />} />
            <Route path="/reports/dynamic-risk" element={<ReportsPage moduleFilter="dynamic-risk" />} />
            <Route path="/reports/:module" element={<ReportsWrapper />} />
