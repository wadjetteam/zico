...
export const NAV_SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: "/risk/treatment", label: "Risk Treatment" },
      ...
      { to: "/risk/users", label: "Risk Owners" },
      { to: "/risk/following-up", label: "Risk Follow-ups" },
    ],
  },
  {
    id: "controls",
  ...
  },
  {
    ...
    items: [
      ...
      { to: "/reports/executive", label: "Executive Summary" },
      { to: "/reports/dynamic-risk", label: "Dynamic Risk Report" },
